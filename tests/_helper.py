...
def check_internet_connectifity(host: str="8.8.8.8", port: int=53, timeout: int=3):
    """
...
def download(url_path: str, local_path: Optional[str]=None, filename: Optional[str]=None) -> str:
...
class TestCase(unittest.TestCase):
    ...
    def assertIsExecutable(self, module: str):
